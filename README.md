...
<p align="center">
    <a href='https://www.github.com/CodeXOm01/disable-devtool'>
...
declare interface IConfig {
    ...
    timeOutUrl?: string; // Turn off URLs that page timeouts forward towards, the default is https://CodeXOm01.github.io/disable-devtool/404.html?h=${encodeURIComponent(location.host)}
